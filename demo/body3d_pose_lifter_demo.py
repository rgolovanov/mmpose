...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=-1,
        type=int,
        help="Max number of frame to be processed",
    )
...
def main():
    ...
    if input_type == "image":
        ...
        frame_count = frame_count if args.frame_count == -1 else args.frame_count
        ...
        for frame_idx in tqdm(range(frame_count)):
            ...
            (pose_est_results, pose_est_results_list, pred_3d_instances, next_id) = (
                process_one_image(
                    args=args,
                    detector=detector,
                    frame=frame,
            ...
            if args.save_predictions:
                ...
                pred_instances_list.append(
                    dict(
                        ...
                        instances_2d=split_instances(
                            merge_data_samples(pose_est_results).get(
                                "pred_instances", None
                            )
                        ),
                    )
    ...
    if args.save_predictions:
        with open(args.pred_save_path, "w") as f:
            json.dump(
                dict(
                    meta_info_2d=pose_estimator.dataset_meta,
                    meta_info_3d=pose_lifter.dataset_meta,
